...
const isSeller = useSelector((state) => state.auth?.role) === "MERCHANT";

const { buttonText, redirectPath } = (() => {
  switch (role.toUpperCase()) {
    case "CUSTOMER":
      
      return { buttonText: "Become Seller", redirectPath: "/signup-seller" };
    case "MERCHANT":
    case "SUPERADMIN":
      return {
        buttonText: "Go Dashboard",
        redirectPath: role.toUpperCase() === "SUPERADMIN"
          ? "/superadmin-dashboard"
          : "/dashboard-create-product",
      };
    default:
      return { buttonText: "Sign Up", redirectPath: "/sign-up" }; // Default to Sign Up
  }
})();
